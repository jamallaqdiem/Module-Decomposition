...
import usernameLoader from "./username_validator.js";
...
app.post("/", usernameLoader, (req, res) => {
  const subjects: string[] = req.body;
  if (!subjects || !Array.isArray(subjects)) {
    return res
      .status(400)
      .send("Bad Request: Expected a JSON array as the body payload.");
  }
